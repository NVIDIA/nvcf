...
run_helper \
  ...
  --nvca-operator-version not-installed \
...
assert_called "annotate namespace primary-unlabeled nvcf.nvidia.com/control-plane-stack=self-managed nvcf.nvidia.com/control-plane-chart-version=1.25.1 nvcf.nvidia.com/nvca-operator-version=not-installed --overwrite"
