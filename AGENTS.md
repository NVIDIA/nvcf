...
- `.codex/skills/<name>/SKILL.md` -> symlink to `.cursor/skills/<name>/SKILL.md`
- `.claude/skills/<name>/SKILL.md` -> symlink to `.cursor/skills/<name>/SKILL.md`
...
3. For dev skills, create `.cursor/skills/<name>` as a symlink to the source directory.
4. For root-wide dev skills, create symlinks for `.codex/skills/<name>/SKILL.md` and `.claude/skills/<name>/SKILL.md`.
5. Update the relevant public or private skills table.
...
| `nvcf-self-managed-cli` | `ai-tooling/user/skills/` | Manage self-managed NVCF through `nvcf-cli` |
