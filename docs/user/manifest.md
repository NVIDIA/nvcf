...
| --- | --- | --- |
| Control plane | `0.19.1` | `deploy/stacks/self-managed/v0.19.1` |
| Compute plane | `0.4.1` | `deploy/stacks/nvcf-compute-plane/v0.4.1` |
| Observability | `0.2.0` | `deploy/stacks/observability/v0.2.0` |
...
| `nvcf-observability-stack` | `0.2.0` | `observability` | Provides the Helmfile bundle for standalone observability deployment. | `Publication pending` | [GitHub](https://github.com/NVIDIA/nvcf/tree/main/deploy/stacks/observability) |
| `nvcf-self-managed-stack` | `0.19.1` | `self-managed` | Provides the Helmfile bundle for control-plane deployment. | `Publication pending` | [GitHub](https://github.com/NVIDIA/nvcf/tree/main/deploy/stacks/self-managed) |
