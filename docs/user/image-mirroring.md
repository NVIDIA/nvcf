...
```bash
# Set stack versions
export STACK_VERSION="0.20.3"
export COMPUTE_STACK_VERSION="0.4.2"
export OBSERVABILITY_STACK_VERSION="0.2.1"

# Download a specific control-plane stack version
# Publication pending: nvcf-self-managed-stack 0.20.3 is not yet available for download.

# Download a specific compute-plane stack version
# Publication pending: nvcf-compute-plane-stack 0.4.2 is not yet available for download.
