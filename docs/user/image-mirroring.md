...
```bash
# Set stack versions
export STACK_VERSION="0.19.1"
export COMPUTE_STACK_VERSION="0.4.1"
export OBSERVABILITY_STACK_VERSION="0.2.0"

# Download a specific control-plane stack version
# Publication pending: nvcf-self-managed-stack 0.19.1 is not yet available for download.
...
# Publication pending: nvcf-observability-stack 0.2.0 is not yet available for download.
```
