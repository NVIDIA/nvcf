...
- `docs/<stack>-<version>/`: frozen per-stack documentation for an exact release, for example `docs/observability-1.3.2/`. Do not edit these trees unless the user explicitly asks for a historical docs fix.
