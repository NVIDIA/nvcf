...
| --- | --- | --- | --- |
| Self-managed (control plane) | `0.20.7` | `deploy/stacks/self-managed/v0.20.7` | `dev` (development) |
| Compute plane | `0.4.4` | `deploy/stacks/nvcf-compute-plane/v0.4.4` | `dev` (development) |
| Observability | `0.2.2` | `deploy/stacks/observability/v0.2.2` | `dev` (development) |
