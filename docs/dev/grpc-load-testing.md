...
If you have not set this up yet, follow the [self-hosted-cli](/nvcf/overview/cli) guide to
install the binary and the [cli-configuration](/nvcf/overview/cli) section to point it at your
gateway.
