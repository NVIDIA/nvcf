...
If you have not set this up yet, follow the [self-hosted-cli](/nvcf/self-managed/cli) guide to
install the binary and the [cli-configuration](/nvcf/self-managed/cli) section to point it at your
gateway.
