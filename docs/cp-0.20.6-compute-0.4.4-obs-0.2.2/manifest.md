...
Documentation: `cp-0.20.6-compute-0.4.4-obs-0.2.2` (qualified)
...
| `nvcf-self-managed-stack` | `0.20.6` | `self-managed` | Provides the Helmfile bundle for control-plane deployment. | `nvcr.io/nvidia/nvcf/nvcf-self-managed-stack:0.20.6` | [GitHub](https://github.com/NVIDIA/nvcf/tree/main/deploy/stacks/self-managed) |
