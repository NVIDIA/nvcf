...
type clusterDTO struct {
	...
	SSAClientID            string   `json:"ssaClientId"` // Deprecated: Use OAuthClientID instead
...
// getClientID returns the OAuth client ID, preferring OAuthClientID over SSAClientID
func (c *clusterDTO) getClientID() string {
	if c.OAuthClientID != "" {
		return c.OAuthClientID
	}
	return c.SSAClientID
}

// VaultEnabled if the OAuthClientID or SSAClientID is specified
