...
```liquid
# Copy-paste your ESS Agent template here
```

### Command

```shell
# Place your ESS Agent command here
```

### Debug output

Provide the complete debug output by running with `-log-level=trace`.
...
Are there any other issues (open or closed) that should
be linked here?
