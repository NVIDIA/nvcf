...
class XAccountAuthorizedPartiesControllerTest {
    ...
    void getAuthorizedPartiesForAllFunctions() {
        ...
        assertThat(functionsByVersion.get(TEST_VERSION_ID_1).id())
                .isEqualTo(TEST_FUNCTION_ID);
        ...
        assertThat(functionsByVersion.get(TEST_VERSION_ID_2).id())
                .isEqualTo(TEST_FUNCTION_ID);
        assertThat(functionsByVersion.get(TEST_VERSION_ID_2).authorizedParties())
                .containsExactlyInAnyOrderElementsOf(functionAuthorizedParties);
        assertThat(functionsByVersion.get(TEST_VERSION_ID_3).id())
                .isEqualTo(TEST_FUNCTION_ID_3);
