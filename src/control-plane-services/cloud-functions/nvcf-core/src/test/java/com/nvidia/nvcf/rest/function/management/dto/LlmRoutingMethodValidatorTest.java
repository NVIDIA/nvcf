...
class LlmRoutingMethodValidatorTest {
    ...
    private static Stream<Arguments> invalidRoutingMethods() {
        return Stream.of(
                ...
                Arguments.of("pulsar;max-queued=1", "must be key=value"),
                Arguments.of("pulsar;_n=1", "must be key=value"),
                Arguments.of("pulsar;seed=1abc", "value for 'seed'"),
                Arguments.of("pulsar;seed=-abc", "value for 'seed'"),
                Arguments.of("pulsar;seed=a\tb", "value for 'seed'"),
                Arguments.of("pulsar;seed=a" + (char) 0x7f + "b", "value for 'seed'"),
