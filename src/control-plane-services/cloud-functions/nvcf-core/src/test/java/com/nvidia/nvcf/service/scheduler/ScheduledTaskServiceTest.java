...
class ScheduledTaskServiceTest {
    ...
    @Mock
    private FunctionDeploymentsRegionProvider regionProvider;
    ...
    void beforeEach() {
        ...
        scheduledTaskService = new ScheduledTaskService(
                functionDeploymentsTask, cleanNatsStreamsTask, regionProvider);
    ...
    void shouldRunFunctionDeploymentsTask() throws InterruptedException {
        when(regionProvider.currentRegion()).thenReturn("test-region");

        scheduledTaskService.functionDeployments();

        verify(regionProvider).currentRegion();
